...
- [x] ~~5. animation should flip tiles one by one instead of all at once.~~
- [x] ~~6. extend the valid guess lists to include more esoteric words, like "raddy"~~
- [x] ~~7. let's add a feature where clicking on a word, looks up the definition and add a voice mode where clicking on the defintion reads it out loud.~~
