...
class WordList(context: Context) {
    ...
    private val answers6: List<String> by lazy { loadAsset(context, "words_6.txt") }
    ...
    private val guesses6: Set<String> by lazy { loadAsset(context, "guesses_6.txt").toHashSet() }
